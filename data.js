  ...
  stages: [
    {
      ...
      roles: [
        { id: "reg_absent", title: "登錄出缺席及名單發放", assignee: "XXX, XXX", desc: "將名單登錄，並於 19:30 將最終名單交給遞證書人員，以便將未出席者證書放在下面。" },
        { id: "explain_stickers", title: "說明豆豆貼與提醒供僧", assignee: "XXX, XXX", desc: "全勤(紅)、福慧(黃)、精進(綠)、勤學(白)，貼於學員身上，號碼為領獎順序。擺放紅包袋並提醒有供僧。" },
        { id: "guide_seats", title: "座椅座位引導", assignee: "XXX, XXX", desc: "引導各組學員依照座位表入座。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "rehearse_explain", title: "預演說明", assignee: "XXX", desc: "口頭說明流程行儀與動作要領。" },
        { id: "rehearse_demo", title: "預演動作示範", assignee: "學長團隊", desc: "示範問訊、領證、持證、齊唱「在哪裡」以及退場動線。" },
        { id: "weina_yuezhong", title: "維那.悅眾", assignee: "XXX, XXX", desc: "負責預演及典禮過程中的梵唄領唱與木魚板眼調控。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "wel_emcee", title: "司儀呼班", assignee: "XXX", desc: "主持典禮，負責呼請「恭迎住持法師、大眾法師」等號令。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "award_hand_cert", title: "遞證書與獎品", assignee: "XXX, XXX", desc: "由東單遞送證書＆獎品，可先放2盤在住持法師講桌上。" },
        { id: "award_pull_line", title: "中央走道拉班", assignee: "XXX, XXX", desc: "負責中央走道拉班，拉班順序為第 1 ➡ 12 組，一組一組上台領證。" },
        { id: "award_guide_up", title: "引導上台", assignee: "XXX", desc: "在講堂前方引導學員依序上台定位。" },
        { id: "award_guide_down", title: "引導下台歸位", assignee: "XXX", desc: "引導拍照完學員走師父椅後方，從西單前廊出，再由講堂後門歸位。" },
        { id: "award_cut_pos", title: "切班定位(拍照)", assignee: "XXX(東), XXX(西)", desc: "負責舞台前方東西兩側，調整學員切班與合照定位站姿。" },
        { id: "award_check_list", title: "核對名單", assignee: "XXX, XXX", desc: "現場核對出缺席與上台名單，如有缺席者，需通知遞證書人員將其證書置底。" },
        { id: "award_corridor_guide", title: "走廊引導", assignee: "XXX", desc: "在清淨後方及廊道引導排班的學員動線。" },
        { id: "award_emcee", title: "司儀", assignee: "XXX", desc: "呼「第X組」出班，主持典禮節奏。" },
        { id: "award_audio", title: "音響", assignee: "XXX, XXX", desc: "負責播放《在哪裡》歌曲，配合拉班與拍照節奏控制音量。" },
        { id: "award_photo", title: "攝影拍照", assignee: "XXX", desc: "負責舞台合照與現場花絮拍攝。" },
        { id: "award_light", title: "控燈", assignee: "XXX", desc: "維持大合照時講堂最佳照明亮度。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "awards_full_check", title: "核對名單與拉班", assignee: "XXX, XXX", desc: "在清淨後方核對紅色豆貼號碼，並引導全勤學員出班集合。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "awards_sincere_check", title: "核對名單與拉班", assignee: "XXX, XXX", desc: "在清淨後方核對黃色豆貼，引導福慧精進學員依序排班。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "awards_diligence_check", title: "核對名單與拉班", assignee: "XXX, XXX", desc: "後方集合精進獎學員，核對綠色豆貼引導上台。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "awards_study_check", title: "核對名單與拉班", assignee: "XXX, XXX", desc: "後方集合勤學獎學員，核對白色豆貼引導上台。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "bodhi_pull_leader", title: "學長拉班", assignee: "XXX", desc: "於全勤獎頒發時，引導學員長團隊出位至講堂後方集合排班。" },
        { id: "bodhi_pull_staff", title: "課務拉班", assignee: "XXX", desc: "於全勤獎頒發時，引導課務團隊出位至講堂後方集合排班。" },
        { id: "bodhi_leader_rep", title: "總學長領獎代表", assignee: "永昌", desc: "代表全體學員長與學長團隊上台接受住持法師頒獎。" },
        { id: "bodhi_staff_rep", title: "課務長領獎代表", assignee: "XXX", desc: "代表全體課務團隊上台接受住持法師頒獎。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "share_bell", title: "敲地鐘提醒", assignee: "XXX", desc: "負責計時，超過 3 分鐘敲地鐘 1 聲，之後依時限加敲，提醒發言者。" },
        { id: "share_speakers", title: "心得分享代表", assignee: "XXX, XXX, XXX", desc: "準備心得稿，依司儀呼班上台站於法師旁分享。" },
        { id: "share_mic", title: "遞無線麥克風", assignee: "XXX, XXX", desc: "負責遞送無線麥克風給分享學員，並在分享結束後收回。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "sermon_emcee", title: "司儀呼班", assignee: "XXX", desc: "呼班起立，問訊，恭請住持法師慈悲開示。" },
        { id: "sermon_audio", title: "音響播影片", assignee: "音響組", desc: "播放「我學佛•我分享」影片與麥克風音量調控。" },
        { id: "sermon_light", title: "控燈(影片)", assignee: "XXX", desc: "播放影片時關燈，開示時恢復講堂明亮。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "lamp_flip", title: "翻亮大眾燈", assignee: "XXX, XXX, XXX, XXX", desc: "在走廊快速將 12 盤大眾燈 (共 144 盞) 翻亮。" },
        { id: "lamp_control", title: "控燈人員", assignee: "XXX", desc: "開始傳燈時負責關閉室內明燈、開啟大門。" },
        { id: "lamp_tray_push", title: "遞燈托盤與推車", assignee: "XXX, XXX, XXX", desc: "清淨前門推入燈車於西單櫃前，由西單一一遞托盤上呈給師父。" },
        { id: "lamp_receiver", title: "學員長接燈傳燈", assignee: "12位學員長", desc: "東單排班上台接燈，捧回小組傳燈，最後捧1盞站在佛前 (中留空位) 帶唱。" },
        { id: "lamp_choir_lead", title: "助唱引導", assignee: "XXX", desc: "手持無線麥克風，引導及協助大眾捧燈齊唱《獻給導師》。" },
        { id: "lamp_collect_left", title: "收剩餘燈具", assignee: "XXX", desc: "將剩下的燈收於 1 盤，放置在禪堂大門內左側黑色座墊上，待補滿摩尼寶珠燈板空缺。" }
      ],
      mapId: "map_lamps",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "vow_stand", title: "遞經架", assignee: "XXX", desc: "遞送住持法師與東單大眾法師的發願文經架。" },
        { id: "vow_monk_lamp", title: "遞大眾法師燈", assignee: "XXX", desc: "遞送大眾法師水晶托盤燈具共 5 盞。" },
        { id: "vow_abbot_lamp", title: "遞住持主法燈", assignee: "XXX", desc: "遞送住持法師黑色四方盤燈具 1 盞。" },
        { id: "vow_mic", title: "遞麥克風", assignee: "XXX", desc: "協助呈遞無線麥克風給住持法師。" }
      ],
      mapId: "map_lamps",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "off_pull_hall", title: "拉班至禪堂(引導)", assignee: "XXX", desc: "帶領隊伍二路移壇，由清淨講堂走廊有序進入禪堂。" },
        { id: "off_pull_out", title: "拉班出位", assignee: "XXX", desc: "負責在講堂出口及禪堂入口維持隊伍拉班間距與速度。" },
        { id: "off_cut_east", title: "東前切班定位", assignee: "XXX", desc: "於禪堂前半段東單位置協助學員切班與定位。" },
        { id: "off_cut_west", title: "西前切班定位", assignee: "XXX", desc: "於禪堂前半段西單位置協助學員切班與定位。" },
        { id: "off_guide_east_post", title: "東後引導定位", assignee: "XXX", desc: "於禪堂後半段東側引導學員站定位置。" },
        { id: "off_guide_west_post", title: "西後引導定位", assignee: "XXX", desc: "於禪堂後半段西側引導學員站定位置。" },
        { id: "off_demo_east", title: "東單呼班.示範手勢", assignee: "XXX(東)", desc: "東單學員供燈供僧禮儀與手勢引導示範。" },
        { id: "off_demo_west", title: "西單呼班.示範手勢", assignee: "XXX(西)", desc: "西單學員供燈供僧禮儀與手勢引導示範。" },
        { id: "off_refill_lamp", title: "排燈補燈與引導", assignee: "XXX", desc: "引導供奉，並於最後將摩尼寶珠燈板上 144 盞燈全部補齊排好。" },
        { id: "off_collect_redbag", title: "紅包收納", assignee: "XXX", desc: "備大紙袋，在供僧結束後，將盤內紅包收齊並交予指導法師。" },
        { id: "off_control_light", title: "控燈", assignee: "XXX", desc: "於供燈、供僧法會完畢時，開啟全場照明。" },
        { id: "off_chairs", title: "排椅/備法師椅", assignee: "XXX", desc: "負責禪堂內法師座椅的清點與排設（住持獅子座、大眾法師座椅 5 張）。" },
        { id: "off_card_hold", title: "大合照字卡拿取", assignee: "XXX", desc: "大合照時，安排摩尼寶珠板最前方的六位學員負責拿 12 片大合照字卡。" }
      ],
      mapId: "map_offering",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "farewell_emcee", title: "司儀呼班", assignee: "XXX", desc: "呼班「恭送住持法師、大眾法師」等指令。" }
      ],
      mapId: "map_offering",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "ann_speaker", title: "法務佈達說明", assignee: "XXX", desc: "負責宣講近期法會資訊及新班推廣事項。" },
