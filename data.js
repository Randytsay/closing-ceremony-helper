  ...
  stages: [
    {
      ...
      roles: [
        ...
        { id: "explain_stickers", title: "說明豆貼與提醒供僧", assignee: "曾雅蘭(傳昧)、田品萱(法印)", desc: "全勤(紅)、福慧(黃)、精進(粉紅)、勤學(白)，貼於學員身上，號碼為領獎順序。擺放紅包袋並提醒有供僧。" },
    ...
    },
    {
      ...
      roles: [
        { id: "awards_diligence_check", title: "核對名單與拉班", assignee: "曾雅蘭(傳昧)、田品萱(法印)", desc: "後方集合精進獎學員，核對粉紅色豆貼引導上台。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        ...
        { id: "bodhi_staff_rep", title: "課務長領獎代表", assignee: "江美惠(傳彿)", desc: "代表全體課務團隊上台接受住持法師頒獎。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "share_bell", title: "敲地鐘提醒", assignee: "邱黃秀枝(傳開)", desc: "負責計時，超過 3 分鐘敲地鐘 1 聲，3分半2聲，4分鐘之後依時限加敲，提醒發言者。" },
    ...
    },
    {
      ...
      roles: [
        ...
        { id: "sermon_light", title: "控燈(影片)", assignee: "林麗嬌(傳霈)", desc: "播放影片時關燈，開示時恢復講堂明亮。" }
      ],
      mapId: "map_awards",
      positions: [
    ...
    },
    {
      ...
      roles: [
        { id: "lamp_flip", title: "翻亮大眾燈", assignee: "曾雅蘭(傳昧)、田品萱(法印)、張雅雯(法空)、鄭秀美(法岫)", desc: "在走廊快速將 9 盤大眾燈 (共 108 盞) 翻亮。" },
        { id: "lamp_control", title: "控燈人員", assignee: "黃湘婷(傳麗)", desc: "開始傳燈時負責關閉室內明燈、開啟大門。" },
    ...
    },
    {
      ...
      roles: [
        ...
        { id: "off_refill_lamp", title: "排燈補燈與引導", assignee: "林麗嬌(傳霈)、張嘉年(法足)", desc: "引導供奉，並於最後將摩尼寶珠燈板上 108 盞燈全部補齊排好。" },
        ...
        { id: "off_card_hold", title: "大合照字卡拿取", assignee: "李素蘭(法洛)", desc: "大合照時，安排摩尼寶珠板最前方的六位學員負責拿 12 片大合照字卡。" }
      ],
      mapId: "map_offering",
      positions: [
